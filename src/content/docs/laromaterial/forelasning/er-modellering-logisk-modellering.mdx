---
title: "ER modellering - logisk modellering"
...
Du kan själv bläddra igenom [de HTML slides som används i presentationen](https://dbwebb.se/kursmaterial/databas/forelasning/v1/f04-er-oversatt-till-relationsmodellen/slide.html).
