---
title: "Funktioner och programmera i databasen"
...
Du kan själv bläddra igenom [de HTML slides som används i presentationen](https://dbwebb.se/kursmaterial/databas/forelasning/v1/f06-funktioner/slide.html).
