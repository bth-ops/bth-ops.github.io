---
title: "Transaktioner i databaser - ACID"
...
Du kan själv bläddra igenom [de HTML slides som används i presentationen](https://dbwebb.se/kursmaterial/databas/forelasning/v1/f04-transaktioner/slide.html).
