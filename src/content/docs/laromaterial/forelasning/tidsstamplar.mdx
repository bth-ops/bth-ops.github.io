---
title: "Tidstämplar i databastabell"
...
Du kan själv bläddra igenom [de HTML slides som används i presentationen](https://dbwebb.se/kursmaterial/databas/forelasning/v1/f05-procedurer-och-trigger/slide-tidstamplar.html).
