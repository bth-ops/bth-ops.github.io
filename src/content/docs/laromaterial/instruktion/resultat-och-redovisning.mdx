...
Du skriver din redovisningstext i filen `README.md` som finns för varje kmom i ditt kursrepo.
...
Kan du koppla och jämföra (reflektera, resonera) dina lärdomar från nuvarande kursmoment mot andra kursmoment, kurser eller andra lärdomar du har sedan tidigare? Sånt gillar lärare.
...
Den vanligaste anledningen till komplettering är att man missat någon liten del som står i kraven för uppgiften. Gör en egen självtest att du uppfyller alla kraven i uppgiften, det kan spara en del tid. Dessutom vill man alltid göra en perfekt inlämning, eller hur?

Kontrollera att GitHub verkligen innehåller den allra senaste versionen av din kod. Dubbelkolla på GitHub att senaste versionen/committen av din kod finns där, du kan tex titta i "Latest commit" på GitHub-sidan för ditt repo.

Dubbelkolla även att sista versionen av din redovisningstext finns publicerat på GitHub Pages. 
...
Det sker ingen betygsättning, bedömning eller återkoppling när du är klar och lämnar in kmom07 och kmom08. 

**När du lämnar in kmom10** rättas den och samtidigt kontrolleras att du har godkänt på inlämningen för kmom03 och kmom06 samt kmom07. kmom08. Därefter får du ditt godkända betyg A-E eller Fx för komplettering eller F för underkänt. Betyget på kmom10 blir också ditt slutbetyg på kursen.
...
Läraren kommer då att titta på din inlämning och betygsätta den.
